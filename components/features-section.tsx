...
export const features = [
  {
    ...
    description:
      "Data-driven paid media campaigns (Google, Meta) that maximize ROI and scale customer acquisition.",
  ...
  },
  {
    ...
    description:
      "Technical SEO, content planning, and on-page optimization to increase organic traffic and rankings.",
  ...
  },
  {
    ...
    description:
      "Creative social content, community management, and paid social ads to grow engagement and conversions.",
  ...
  },
  {
    ...
    description:
      "Brand identity, visual systems, and campaign creative that tell your story and convert visitors into customers.",
  ...
  },
  {
    ...
    description:
      "Actionable dashboards, A/B testing, and performance insights to continuously improve channel results.",
  ...
  },
  {
    ...
    description:
      "Dedicated account strategy, onboarding, and growth plans to ensure campaigns deliver business outcomes.",
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          >
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-slate-100 border border-slate-200 text-slate-700 text-sm font-medium mb-6">
              ...
              Agency Services — Results-Driven Marketing
            </div>
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-slate-900 text-balance mb-4 sm:mb-6">
              ...
              <span className="bg-linear-to-r from-slate-600 to-slate-400 bg-clip-text text-transparent">
                With an Expert Marketing Agency
              </span>
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-slate-600 max-w-3xl mx-auto font-light leading-relaxed">
              We plan, launch, and optimize campaigns that drive leads, sales, and brand awareness — strategy, creative,
              ads, and analytics handled end-to-end so you can focus on scaling.
            </p>
          </div>
