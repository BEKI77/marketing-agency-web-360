...
export function DealershipHeroHeader() {
  ...
  return (
    <div className="space-y-8">
      <h1 className="text-4xl  font-bold text-white leading-tight text-balance animate-fade-in-heading">
      ...
      <div className="animate-fade-in-subheading">
        ...
        <div className="flex flex-col items-start gap-2 sm:hidden">
          ...
          <span className="text-3xl font-bold bg-linear-to-r from-red-400 to-orange-400 bg-clip-text text-transparent animate-pulse-glow">
            €{counter}K+
          </span>
        ...
        <div className="hidden sm:flex items-center justify-start gap-2 sm:gap-3 flex-wrap">
